...
#line 62 "src/scheme.tab.c" /* glr.c:240  */
...
#line 95 "src/scheme.tab.c" /* glr.c:263  */
...
{
  "$end", "error", "$undefined", "BOOLEAN_T", "FIXNUM_T", "FLONUM_T",
  "CHARACTER_T", "STRING_T", "SYMBOL_T", "'('", "')'", "$accept", "EXPR",
  "LIST", "ITEM", "ATOM", YY_NULLPTR
};
#endif
...
{
       1,     2,     3,     4,     5,     6,     7,    13,     1,     2,
       3,     4,     5,     6,     7,    12,     0,    14,    15
};
...
# define YYBACKUP(Token, Value)                                              \
  ...
  switch (yyn)
    {
        case 4:
#line 29 "src/scheme.y" /* glr.c:816  */
    { printf("list\n"); }
#line 886 "src/scheme.tab.c" /* glr.c:816  */
    break;

  case 8:
#line 37 "src/scheme.y" /* glr.c:816  */
    {printf("bool = %s\n", yylval.str);}
#line 892 "src/scheme.tab.c" /* glr.c:816  */
    break;

  case 9:
#line 38 "src/scheme.y" /* glr.c:816  */
    {printf("fixnum = %s\n", yylval.str);}
#line 898 "src/scheme.tab.c" /* glr.c:816  */
    break;

  case 10:
#line 39 "src/scheme.y" /* glr.c:816  */
    { printf("flonum = %s\n", yylval.str); }
#line 904 "src/scheme.tab.c" /* glr.c:816  */
    break;

  case 11:
#line 40 "src/scheme.y" /* glr.c:816  */
    { printf("char = %s\n", yylval.str); }
#line 910 "src/scheme.tab.c" /* glr.c:816  */
    break;

  case 12:
#line 41 "src/scheme.y" /* glr.c:816  */
    { printf("string = %s\n", yylval.str); }
#line 916 "src/scheme.tab.c" /* glr.c:816  */
    break;

  case 13:
#line 42 "src/scheme.y" /* glr.c:816  */
    { printf("symbol = %s\n", yylval.str); }
#line 922 "src/scheme.tab.c" /* glr.c:816  */
    break;


#line 926 "src/scheme.tab.c" /* glr.c:816  */
      default: break;
    }
...
#line 45 "src/scheme.y" /* glr.c:2584  */
